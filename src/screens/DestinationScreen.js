  ...
  return (
    <View className="bg-white flex-1">
        ...
        <View style={{borderTopLeftRadius: 40, borderTopRightRadius: 40}} className="px-5 flex flex-1 justify-between bg-white pt-8 -mt-14">
            ...
            <TouchableOpacity onPress={()=>{navigation.navigate("Basket")}}  style={{backgroundColor: theme.bg(0.8), height: wp(15), width: wp(50)}} className="mb-6 mx-auto flex justify-center items-center rounded-full">
